...
module.exports = async name => {
    clear()
    const data = await figlet.textSync('Vite Project', {
        font: 'Ghost',
    ...
    // await spawn(process.platform === 'win32' ? 'npm.cmd' : 'npm',['install'], { stdio: 'inherit',shell: process.platform === 'win32',cwd: `./${name}`})
